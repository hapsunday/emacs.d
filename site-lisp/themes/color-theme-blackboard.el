;; 原始的链接 ref: http://blog.jdhuntington.com/2008/11/emacs-color-theme-blackboard.html
;; 经人修改后的链接 ref: http://emacser.com/torture-emacs.htm
;; 
  ...
  (color-theme-install
   '(color-theme-blackboard
     ...
     ;;(if window-system
      ...
      (default ((t (:background "#080808" :foreground "#F8F8F8"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
;;         (buffers-tab ((t (:background "#0C1021" :foreground "#F8F8F8"))))
       (buffers-tab ((t (:background "#080808" :foreground "#F8F8F8"))))
